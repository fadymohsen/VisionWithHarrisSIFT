...
class HarrisCornerDetection():
    def __init__(self, main_tab_widget):
        ...
        self.ui.horizontalSlider_6.setMaximum(20)
        self.ui.horizontalSlider_6.setSingleStep(1)
        self.ui.horizontalSlider_6.setValue(1)
        self.ui.horizontalSlider_6.valueChanged.connect(self.slider_changed)
        ...
        if hasattr(self.ui, 'label_threshold'):
            ...
            self.update_label_threshold(self.ui.horizontalSlider_6.value())
        else:
            print("Label 'label_threshold' not found. Check your UI design.")
        self.original_image = None
        if hasattr(self.ui, 'harris_lambda'):
            self.ui.harris_lambda.currentIndexChanged.connect(self.detect_corners)
        else:
            print("ComboBox 'harris_lambda' not found. Check your UI design.")
    ...
    def detect_corners(self):
        ...
        threshold_type = self.ui.harris_lambda.currentText()  # Read the selected option from the combobox
        # Start the timer
        ...
        if threshold_type == 'Harris':
            ...
            # Highlight corners with red spots
            ...
            threshold_lambda = 0.9 * lambda_minus

            # Update threshold based on slider value
            threshold = self.scaled_threshold_ratio * np.max(threshold_lambda)
